...
\label{tab:rq-matrix}
\begin{tabular}{@{}p{0.16\linewidth}p{0.47\linewidth}>{\centering\arraybackslash}p{0.061\linewidth}>{\centering\arraybackslash}p{0.061\linewidth}>{\centering\arraybackslash}p{0.061\linewidth}>{\centering\arraybackslash}p{0.061\linewidth}@{}}
\toprule
